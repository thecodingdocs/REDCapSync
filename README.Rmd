...
```{r, fig.alt = "A diagram of REDCapSync framework showing projects to project to dataset.", out.width="100%"}
...
```{r, fig.alt = "Shows on REDCap website user rights page the user with the token needs API token export privileges and ideally logging privileges.", out.width="100%"}
...
```{r, fig.alt = "An epic handshake between REDCap and R as an illustration of REDCapSync.", out.width="100%"}
knitr::include_graphics("man/figures/cover.jpg")
```

```{r, fig.alt = "A logo for thecodingdocs.com with a stethoscope that looks like coding brackets.", out.width="100%"}
