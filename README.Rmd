...
Getting started is as simple as 1.) setting your token, 2.) setting up a project, and 3.) running project\$sync(). See [Getting Started](REDCapSync.html "Getting Started") page for the basics! If you need more help setting your tokens, see the Tokens vignette. 
