...
[![Codecov test coverage](https://codecov.io/gh/thecodingdocs/REDCapDB/graph/badge.svg)](https://app.codecov.io/gh/thecodingdocs/REDCapDB)
...
REDCapDB can be used as a base data object and data quality tool for most REDCap projects to aid in collection, monitoring, transformation, and analysis.

## Installing REDCapDB

*Note: The current version of `{REDCapDB}` used when writing this book is `r packageVersion("REDCapDB")`, and some of the features presented in this book might not be available if you are using an older version, or be a little bit different if you have a newer version. Feel free to browse the package NEWS.*
...
You can install the development version of REDCapDB from GitHub by using the `{remotes}` package.
...
Note that the version used at the time of writing this book is `r packageVersion("REDCapDB")`.
...
-   The REDCapDB package is at [github.com/thecodingdocs/REDCapDB](https://github.com/thecodingdocs/REDCapDB "REDCapDB R package"). See instructions above.
