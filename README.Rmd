...
Getting started is as simple as 1.) setting your token, 2.) setting up a project, and 3.) running project\$sync(). See [Getting Started](https://thecodingdocs.github.io/REDCapSync/articles/REDCapSync.html "Getting Started") page for the basics! If you need more help setting your tokens, See the [Tokens](vignette("Tokens", package = "REDCapSync")) vignette. 
...
For an in-depth demonstration of both REDCapSync and RosyREDCap, see [thecodingdocs.github.io/RMed26-Demo](https://thecodingdocs.github.io/RMed26-Demo/ "RMed26-Demo").
