...
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/grand-total/REDCapSync)](https://CRAN.R-project.org/package=REDCapSync)
<!-- badges: end -->
...
Getting started is as simple as 1.) setting your token, 2.) setting up a project, and 3.) running project\$sync(). See [Getting Started](https://thecodingdocs.github.io/REDCapSync/articles/REDCapSync.html "Getting Started") page for the basics! 
