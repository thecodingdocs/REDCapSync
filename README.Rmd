...
However, [`REDCapSync`](https://thecodingdocs.github.io/REDCapSync) is the first "get-everything" REDCap R package that 
converts REDCap projects into a standardized, API-efficient, and 
project-agnostic [R6][R6::R6Class] object [R6::R6Class] [`R6::R6Class`] `R6::R6Class`. 

## What is REDCapSync?

[`REDCapSync`](https://thecodingdocs.github.io/REDCapSync) unleashes the full power of the REDCap API even for the basic R user. When a sync is performed, [`REDCapSync`](https://thecodingdocs.github.io/REDCapSync) uses a cache of previous saves, a user-defined directory, and the REDCap log to only update data that changed since the last API call. Project objects can be used for the best that R has to offer via statistics, visualization, functions, shiny apps, and more! 
