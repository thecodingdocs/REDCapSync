...
![Shows on REDCap website user rights page the user with the token needs
API token export privileges and ideally logging
privileges](reference/figures/redcap_priv.png)

Shows on REDCap website user rights page the user with the token needs
API token export privileges and ideally logging privileges
...
![An epic handshake between REDCap and R as an illustration of
REDCapSync](reference/figures/cover.jpg)

An epic handshake between REDCap and R as an illustration of REDCapSync

[![A logo for thecodingdocs.com with a stethoscope that looks like
coding
brackets](reference/figures/TCD.png)](https://www.thecodingdocs.com)
