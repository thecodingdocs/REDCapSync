...
This can be customized with `add_project_summary` for refreshing datasets or `generate_project_summary` for R-only use. This can give you filtered data (and corresponding annotations to metadata, etc), de-identified data, and more!
