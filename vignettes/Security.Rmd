...
REDCapSync encrypts the DB objects that are saved in the user-chosen directory. That file can only be imported into R if that user also has the API token.
