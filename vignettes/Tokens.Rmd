...
#>[1] ""
# Assuming you already setup or loaded a project object you can set the token like this...
project <- load_project("TEST")
set_REDCap_token(project)
```
...
If you are ever having any issues with your token, you can test your project object with `view_REDCap_token(project)` and/or `test_REDCap_token(project)`

```{r, eval=FALSE}

view_REDCap_token(project)

test_REDCap_token(project)
